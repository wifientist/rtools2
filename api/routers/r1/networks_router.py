...
from clients.r1_client import create_r1_client_from_tenant, get_tenant_aware_r1_client
...
async def get_wifi_networks(tenant_id: str, r1_client: R1Client = Depends(get_tenant_aware_r1_client)):
